...
func NewUpdateChannelCommand(f *factory.Factory) *cobra.Command {
	opts := options{
		f: f,
	}
	...
	cmdutil.AddRevision(cmd, &opts.revision).Required()
...
func run(opts *options) error {
	...
	updateBody := map[string]interface{}{
		"spec": map[string]interface{}{
			"shard_metadata": map[string]interface{}{
