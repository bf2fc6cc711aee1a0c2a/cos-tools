...
func (r ApiGetClusterDeploymentsRequest) OperatorUpdates(operatorUpdates bool) ApiGetClusterDeploymentsRequest {
	r.operatorUpdates = &operatorUpdates
	return r
}
...
func (a *ConnectorClustersAdminApiService) GetClusterDeploymentsExecute(r ApiGetClusterDeploymentsRequest) (*ConnectorDeploymentAdminViewList, *http.Response, error) {
	...
	if r.operatorUpdates != nil {
		localVarQueryParams.Add("operator_updates", parameterToString(*r.operatorUpdates, ""))
	}
...
// include only deployments that have operator updates
func (r ApiGetNamespaceDeploymentsRequest) OperatorUpdates(operatorUpdates bool) ApiGetNamespaceDeploymentsRequest {
	r.operatorUpdates = &operatorUpdates
	return r
}
